        ...
        <div class="content-area">
            <div class="container">
                <div class="row <?php echo ($madara_sidebar == 'left') ? 'sidebar-left' : '' ?>">
                    ...
                    <div class="<?php echo ($madara_sidebar !== 'full' && ( is_active_sidebar( 'single_post_sidebar' ) || is_active_sidebar( 'main_sidebar' ) )) ? 'main-col col-md-8 col-sm-8' : 'col-md-12 col-sm-12' ?>">
