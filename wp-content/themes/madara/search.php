...
?>
    <div class="c-search-header__wrapper" style="<?php echo ($search_header_background != '') ? $search_header_background : 'background-image: url(' . get_parent_theme_file_uri( '/images/bg-search.jpg' ) . ');'; ?>">
        <div class="container">
            <div class="search-content">
                <form role="search" method="get" class="search-form">
                    <label> <span class="screen-reader-text"><?php esc_html_e( 'Tìm kiếm:', 'madara' ); ?></span>
                        <input type="search" class="search-field" placeholder="<?php esc_html_e( 'Tìm kiếm...', 'madara' ); ?>" value="<?php echo esc_attr( $s ); ?>" name="s">
                    </label> <input type="submit" class="search-submit" value="<?php esc_html_e( 'Tìm kiếm', 'madara' ); ?>">
                </form>
            </div>
        </div>
    </div>
                                ...
                                <div class="tab-wrap">
                                    <div class="c-blog__heading style-2 font-heading">
                                        <h4>
											...
											<?php echo sprintf( _n( '%s kết quả', '%s kết quả', $wp_query->found_posts, 'madara' ), $wp_query->found_posts ); ?>
                                        </h4>
                                    </div>
                                </div>
                                <!-- Tab panes -->
                        ...
                        <div class="search-wrap no-results not-found">
                            <div class="results_content">
                                ...
                                <div class="not-found-content">
                                    <p><?php esc_html_e( 'Không thấy kết quả nào. Thử lại với từ khóa khác...', 'madara' ); ?></p>
                                </div>
                            </div>
                        </div>
						<?php
